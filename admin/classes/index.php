...
$title = "Classes";
$rows = select("SELECT `Id`, `ClassName`, `Description` FROM `Classes`");
// $json_array = array();
        ...
        <section class="content">
            <div class="row">
                <div class="col" style="text-align: end">
                    <a role="button" class="btn btn-success" href="<?= urlOf('admin/classes/create.php') ?>">Create New</a>
                </div>
            </div>
            <div class="row">&nbsp;</div>
                        ...
                        <table class="table table-striped item-list">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="item-list-title" style="width: 20%">ClassName</th>
                                    <th scope="col" class="item-list-title" style="width: 20%">Discription</th>
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < count($rows); $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-list-name"><?= $rows[$i]['ClassName'] ?></td>
                                        ...
                                        <td class="item-list-actions">
                                            <div class="btn-group d-none d-lg-flex" role="group" aria-label="Actions">
                                                <a role="button" class="btn btn-primary" href="<?= urlOf("admin/classes/edit.php?id=$id") ?>" data-toggle="tooltip" data-placement="bottom" title="Edit">
                                                    <i class="far fa-edit"></i>
                                                </a>
                                                <a role="button" class="btn btn-danger" onclick="showDeleteClassConfirmation(<?= $rows[$i]['Id'] ?>)" data-toggle="tooltip" data-placement="bottom" title="Delete">
