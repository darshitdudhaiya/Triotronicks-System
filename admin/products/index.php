...
$title = "Products";
$rows = select("SELECT `Id`, `Name`, `Description` FROM `Products`");
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-list-actions">
                                            <div class="btn-group d-none d-lg-flex" role="group" aria-label="Actions">
                                                ...
                                                <a role="button" class="btn btn-danger" onclick="showDeleteProductsConfirmation(<?= $rows[$i]['Id'] ?>)" data-toggle="tooltip" data-placement="bottom" title="Delete">
