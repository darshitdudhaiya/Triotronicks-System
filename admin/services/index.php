...
$title = "Services";
$rows = select("SELECT `Id`, `Name`, `Description` FROM `Services`");
// $json_array = array();
        ...
        <section class="content">
            <div class="row">
                <div class="col" style="text-align: end">
                    <a role="button" class="btn btn-success" href="<?= urlOf('admin/services/create.php') ?>">Create New</a>
                </div>
            </div>
            <div class="row">&nbsp;</div>
                        ...
                        <table class="table table-striped item-list">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="item-list-title" style="width: 40%">Description</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-list-actions">
                                            <div class="btn-group d-none d-lg-flex" role="group" aria-label="Actions">
                                                <a role="button" class="btn btn-primary" href="<?= urlOf("admin/services/edit.php?id=$id") ?>" data-toggle="tooltip" data-placement="bottom" title="Edit">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button id="btn-yes" type="button" class="btn btn-danger" data-id="<?=$id?>" onclick="deleteService()">Yes</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
